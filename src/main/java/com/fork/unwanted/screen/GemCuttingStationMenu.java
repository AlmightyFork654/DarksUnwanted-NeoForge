...
public class GemCuttingStationMenu extends AbstractContainerMenu {
    ...
    public GemCuttingStationMenu(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 0, 34, 40));
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 1, 57, 18));
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 2, 103, 18));
        this.addSlot(new ModResultSlot(blockEntity.itemHandler, 3, 80, 60));
