...
import com.fork.unwanted.screen.slot.ModFuelSlot;
import com.fork.unwanted.screen.slot.ModResultSlot;
...
public class TorridFurnaceMenu extends AbstractContainerMenu {
    ...
    public TorridFurnaceMenu(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.addSlot(new ModFuelSlot(blockEntity.itemHandler, 0, 44, 53));
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 1, 44, 17));
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 2, 80, 53));
        this.addSlot(new ModResultSlot(blockEntity.itemHandler, 3, 116, 53));
