...
//        modContainer.registerConfig(ModConfig.Type.COMMON, Config.SPEC);
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event)
    {
        ...
        if(event.getTab() == ModCreativeModeTabs.BLOCKS_TAB.get()) {
            ...
            event.accept(ModBlocks.CUT_MARBLE_BRICKS);
            event.accept(ModBlocks.CUT_CRACKED_MARBLE_BRICKS);
            event.accept(ModBlocks.CUT_MOSSY_MARBLE_BRICKS);
            ...
            event.accept(ModBlocks.CUT_MARBLE_BRICKS_STAIRS);
            event.accept(ModBlocks.CUT_CRACKED_MARBLE_BRICKS_STAIRS);
            event.accept(ModBlocks.CUT_MOSSY_MARBLE_BRICKS_STAIRS);
            ...
            event.accept(ModBlocks.CUT_MARBLE_BRICKS_SLAB);
            event.accept(ModBlocks.CUT_CRACKED_MARBLE_BRICKS_SLAB);
            event.accept(ModBlocks.CUT_MOSSY_MARBLE_BRICKS_SLAB);
            ...
            event.accept(ModBlocks.CUT_MARBLE_BRICKS_WALL);
            event.accept(ModBlocks.CUT_CRACKED_MARBLE_BRICKS_WALL);
            event.accept(ModBlocks.CUT_MOSSY_MARBLE_BRICKS_WALL);
