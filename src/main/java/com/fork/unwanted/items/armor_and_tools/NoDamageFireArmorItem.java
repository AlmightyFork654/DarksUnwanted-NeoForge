...
public class NoDamageFireArmorItem extends ArmorItem {
    ...
    public NoDamageFireArmorItem(Holder<ArmorMaterial> material, ArmorItem.Type slot, Item.Properties settings) {
